    ...
    <?php $page = 'about';include 'partials/header.php';?> <!-- premenna ktora určuje classu active na zaklade podstranky na ktorej sme -->
    ...
    <?php include 'partials/footer_alfa.php';?>
